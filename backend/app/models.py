...
class Test(db.Model):
    ...
    date = db.Column(db.DateTime, nullable=False, default=datetime.utcnow)  # Date du test
        ...
        # Relations many-to-many avec les sites, promotions et groupes
    sites = db.relationship('Site', secondary=test_site, backref='tests')
    promotions = db.relationship('Promotion', secondary=test_promotion, backref='tests')
    groupes = db.relationship('Groupe', secondary=test_groupe, backref='tests')
